...
export const HomeIcon = (props: any) => (
  <FontAwesome name="home" size={26} color="white" {...props} />
);

export const InfoIcon = (props: any) => (
  <FontAwesome name="info" size={26} color="white" {...props} />
);
...
export const DBIcon = (props: any) => (
  <FontAwesome6 name="database" size={26} color="white" {...props} />
);
